...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Infrastructure\\Controller\\StatusController' => 'getStatusControllerService',
    ...
    /**
     * Gets the public 'App\Infrastructure\Controller\StatusController' shared autowired service.
     *
     * @return \App\Infrastructure\Controller\StatusController
     */
    protected function getStatusControllerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Controller/StatusController.php';

        return $this->services['App\\Infrastructure\\Controller\\StatusController'] = new \App\Infrastructure\Controller\StatusController();
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eBYpUN2SGn', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9kw7J63H-N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getServicesResetterService()
    {
        ...
        return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
            ...
            return 0 + (int) (isset($this->services['cache.app'])) + (int) (isset($this->services['cache.system'])) + (int) (false) + (int) (false) + (int) (false) + (int) (false) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->services['event_dispatcher']));
